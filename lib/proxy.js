  ...
  ConnectorProxy.prototype.get = function () {
    ...
    if (typeof this.connector.get !== 'function') {
      throw new errors.connector.request.UnsupportedError('get method unsupported');
    }
  ...
  ConnectorProxy.prototype.put = function () {
    ...
    if (typeof this.connector.put !== 'function') {
      throw new errors.connector.request.UnsupportedError('put method unsupported');
    }
  ...
  ConnectorProxy.prototype.post = function () {
    ...
    if (typeof this.connector.post !== 'function') {
      throw new errors.connector.request.UnsupportedError('post method unsupported');
    }
    return this.connector.post.apply(this.connector, arguments);
  };
  ConnectorProxy.prototype.delete = function () {
    logger.info('in connector-pipeline delete');
    if (typeof this.connector.delete !== 'function') {
      throw new errors.connector.request.UnsupportedError('delete method unsupported');
    }
    return this.connector.delete.apply(this.connector, arguments);
  };
  ConnectorProxy.prototype.authorize = function (token) {
    ...
    if (typeof token === 'string') {
      ...
      return this.connector.authorize(token);
    }
  };
