...
var ConnectorProxy = (function () {
  ...
  function ConnectorProxy(connectorSetting) {
    ...
    var connectorPath = path.join(connectorsPath, connectorSetting.connectorType, 'current');
  ...
  _createClass(ConnectorProxy, [{
    ...
    value: function init(context) {
      ...
      return Promise.resolve().then(function () {
        ...
        var methods = (0, _lodash.filter)(Object.getOwnPropertyNames(Object.getPrototypeOf(_this._connector)), function (property) {
          if (property.startsWith('_') || property === 'receiveBounce' || _this[property] || property === 'constructor') {
            return false;
          } else {
            return true;
          }
