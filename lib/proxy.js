...
var ConnectorProxy = (function () {
  ...
  _createClass(ConnectorProxy, [{
    ...
    value: function init(context) {
      ...
      var methods = (0, _lodash.filter)((0, _lodash.functions)(this._connector), function (property) {
      ...
      if (context.bucket && context.bucket.meta && context.bucket.meta.authToken && context.bucket.meta.authToken[this._connectorSetting.key]) {
        return this.authorize(context.bucket.meta.authToken[this._connectorSetting.key])['catch'](function (err) {
